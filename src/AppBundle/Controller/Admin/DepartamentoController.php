...
class DepartamentoController extends Controller
{
    ...
    /**
     * Cria uma nova entidade Departamento
     *
     * @Route("/novo", name="admin_departamentos_new")
     * @Method({"GET", "POST"})
    ...
    /**
     * Exibe uma entidade Departamento
     *
    ...
    /**
     * @Route("/{id}/editar", name="admin_departamentos_edit")
     * @Method({"GET", "POST"})
     */
    ...
    /**
     * @param Departamento $departamento A entidade Departamento
     * @return \Symfony\Component\Form\Form O formulário
     */
